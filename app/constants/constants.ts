...
export const contentServicesListIP: ServicesPackagesType = {
  ...
  description: 'Такой тип ремонта подойдет, если требкеться отремонтировать квартиру: выровнять стены, сделать стяжку полов, проложить инженерию и выполнить чистовую отделку.',
  services: [
...
export const services: ServicesType = {
  ndfl: [
    ...
    {name: 'За каждый дополнительно заявленный вида вычета в одном налоговом периоде', price: '200'},
    {name: 'Составление заявления о распределении имущественного вычета', price: '300'},
    {name: 'Составление пояснений об отсутствии обязанности представления декларации', price: 'от 600'},
  ],
  registration: [
    {name: 'Регистрация ООО с одним учредителем через сервис банка-партнера', price: '1000'},
    {name: 'Регистрация ИП с через сервис банка-партнера', price: '500'},
    {name: 'Заявление о государственной регистрации юридического лица в качестве ИП', price: '400'},
    {name: 'Уведомление о переходе на УСН', price: '300'},
    {name: 'Заявление о прекращении физическим лицом деятельности в качестве ИП', price: '400'},
  ],
  etcServices: [
    {name: 'Восстановление бухгалтерского учета', price: 'от 5000'},
    {name: 'Составление типового трудового договора', price: '600'},
    {name: 'Досудебное обжалование актов / решений налоговых органов', price: 'от 1000'},
    {name: 'Ответ на требования налоговых органов', price: 'от 500'},
    {name: 'Внесение изменений в ЕГРИП / ЕГРН', price: 'от 400'},
    {name: 'Помощь в получении банковской гарантии', price: '1 % от стоимости услуги'},
